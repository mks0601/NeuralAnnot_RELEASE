...
def demo():
    ...
    db = COCO('data/3DPW_train.json')
    # smplx parameter load
    with open('data/3DPW_train_SMPLX_NeuralAnnot.json','r') as f:
    ...
    for aid in db.anns.keys():
        ...
        img_path = osp.join('data', 'imageFiles', sequence_name, img_name)
        ...
        body_pose = torch.FloatTensor(body_pose).view(1,-1)
